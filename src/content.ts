...
// Returns the UUID portion of /chat/<uuid>, or null if not on a chat page.
...
// Claude.ai's React router does not reliably fire pushState or popstate events,
...
// Claude.ai is a React SPA — the scroll container may not exist at document_idle.
// Only wait for it when we're already on a chat page; on /new and other pages
// there is no scroll container and we'd hang until timeout.
